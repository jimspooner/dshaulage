<!-- GET GALLERY ARRAY -->
<?php $gallery_images2 = get_field('2_block_gallery');  ?>
<!-- IF ENABLED -->
<?php if ($gallery_images2['image_1']) : ?>
<!-- BACKGROUND COLOR -->
...
<!-- <div class="uk-position-top uk-background-cover uk-height-small uk-width-1-1" style="background-image:url(<?php echo get_template_directory_uri(); ?>/img/section-top.svg);"></div>     -->
        <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1" uk-slider uk-scrollspy="cls: uk-animation-slide-bottom; target: li; delay: 300; repeat: true">
            <ul class="uk-slider-items uk-child-width-1-1 uk-child-width-1-2@m uk-grid-collapse uk-height-large">
                <li class="uk-cover-container">
                    <img src="<?php echo $gallery_images2['image_1']; ?>" alt="<?php echo get_the_title(); ?> 1" uk-cover>
                </li>
                <li class="uk-cover-container">
                    <img src="<?php echo $gallery_images2['image_2']; ?>" alt="<?php echo get_the_title(); ?> 2" uk-cover>
                </li>
            </ul>
        </div>
