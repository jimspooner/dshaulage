...
<div id='addvehicle'>
    <div id="0" class="first-event uk-text-left" style="display:none;width:100vw;">
        <div class="uk-position-top" style="margin-top:57px;">
            ...
            <div class="uk-padding uk-padding-remove-bottom uk-text-center uk-margin-top-large uk-text-xlarge">Vehicle Details</div>
            <p class="uk-text-center">Add your Vehicle registration plate below</p>
            ...
            <div class="uk-padding uk-padding-remove-top">
                ...
                <textarea type="textarea" placeholder="Your vehicle description" class="uk-textarea" col="20" name="post_description" id="post_description" value="" style="font-size:1.5rem;width:100%;height:250px;padding:10px;"></textarea>
            </div>
            </div>
        </div>
        <div class="uk-position-bottom uk-child-width-1-1 uk-grid-collapse" uk-grid>
            <div class="nodefect uk-padding uk-text-center uk-button uk-bgc-spot2 uk-text-white" id="mileage" data-q="0" data-a="Mileage" style="font-size:1.2rem;">Add</div>
        </div>
</div>
