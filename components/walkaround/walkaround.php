...
<section class="walkaround uk-position-relative" style="top:0;width:100vw;">
<div class="uk-position-top" >
<form id="walkaround_form" action="#" method="POST" data-url="<?php echo admin_url('admin-ajax.php'); ?>" enctype="multipart/form-data">
<div id='defectsq'  uk-height-viewport="offset-top:57px">
<script>
...
jQuery.each(data, function (key, value) {
    quid = value.id;
    defects += '<div id="'+value.id+'" class="uk-text-left" style="display:none;width:100vw;"  uk-height-viewport="offset-top:57px">';
