	...
	<header class="uk-bgc-spot3 uk-padding-small main-header uk-padding-remove-left uk-padding-remove-right" style="min-height:57px;max-height:57px;overflow:hidden;height:40px;" role="banner" uk-sticky>
		 <div class="uk-position-top">
		 	<div class="uk-width-1-1 uk-grid-collapse" uk-grid>
			 	<div class="uk-width-auto"><a href="<?php echo home_url(); ?>" style="max-height:57px;" class="uk-button uk-bgc-spot4 uk-text-white uk-text-lead uk-padding-small"><span class="uk-icon" uk-icon="icon:home;ratio:1.5;"></span></a></div>
			 	<div class="uk-width-expand">
					 <div style="width:100%;" class="uk-grid-collapse" uk-grid>
						<div class="uk-width-auto"><a href="<?php echo home_url(); ?>/walkaround-inspection" class="uk-button uk-bgc-spot3 uk-text-white uk-text-lead uk-padding-small" style="width:100%;border-left:1px solid rgba(255,255,255,.3);"><strong><span class="uk-margin-small-right uk-icon" uk-icon="icon:plus-circle"></span>INSPECTION</strong></a></div>
