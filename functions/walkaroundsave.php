...
function save_walkaround_form_action() {
    ...
    $args = [
        ...
        'post_category'=>array(2, $post_vehicle),
    ...
    update_post_meta( $is_post_inserted, 'month', $_POST['post_details']['post_month'] );
    update_post_meta( $is_post_inserted, 'year', $_POST['post_details']['post_year'] );
